	...
	<div class="col">
		<div class="card bg-default shadow">
			<div class="card-header bg-transparent border-0">
				<div class="row">
					<div class="col-2">
						<h2 class="text-white mb-0">공지글 수정</h2>
					</div>
					<div class="col-10" align="right">
						<button type="button" class="btn btn-primary"
							onclick="makeNotice();">수정하기</button>
								...
								<th scope="row" style="padding-left: 40px">
									<div class="media-body">
										<span class="mb-0 text-lg"><input type="text"
											id="notice_title" style="width: 1500px;"
											value="${post.post_title }"></span>
									</div>
								</th>
							</tr>
						</tbody>
							...
							<tr>
								<td style="font-size: 20px; height: 556px"><span
									class="badge badge-dot mr-4"> <i class="mb-0 text-lg"></i>
										...
										style="width: 1500px; height: 500px; font-size: 25px; padding-top: 0px; padding-bottom: 450px;"
										value="${post.post_content }"></span></td>
							</tr>
						</tbody>
					</table>
				</form>
	...
	function makeNotice() {
		...
		if (confirm("수정하시겠습니까?")) {
			$.ajax({
				...
				type : "post",
				data : query,
				url : "${contextPath}/admin/A_noticeUpdate",
